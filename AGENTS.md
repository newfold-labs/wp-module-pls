# Agent guidance – wp-module-pls

This file gives AI agents a quick orientation to the repo. For full detail, see the **docs/** directory.

## What this project is

- **wp-module-pls** – License key provisioning, validation, and lifecycle events for registered plugins using the PLS API via Hiive. Registers with the Newfold Module Loader; depends on wp-module-data. Maintained by Newfold Labs.

- **Stack:** PHP 7.3+. See docs/dependencies.md.

- **Architecture:** Registers with the loader; consumed by wp-module-installer and others. See docs/integration.md.
